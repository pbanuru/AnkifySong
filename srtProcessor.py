...
class SrtProcessor:
    ...
    def add_remove_buffer(self, subtitle):
        ...
        song_len = timedelta(seconds=self.song.song_length())
    ...
    def processSrtFile(self):
        ...
        with open(self.srt_file_path, "r", encoding="utf-8") as f:
            for i, subtitle in enumerate(srt.parse(f.read()), start=1):
                ...
                subtitle = self.add_remove_buffer(subtitle)
